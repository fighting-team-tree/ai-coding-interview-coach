    ...
    <main className="container">
      <section className="hero hero-shell">
        <div className="hero-panel">
          ...
          <div className="hero-actions">
            ...
            <span className="hero-badge">Normal · Plan B · Fallback</span>
            <span className="hero-badge">Text-first, demo-stable</span>
          </div>
        </div>

        <aside className="hero-aside card">
          <div className="eyebrow">Judge Story</div>
      ...
      <section className="signal-grid">
        {productSignals.map((signal) => (
          <article key={signal.title} className="card feature-card">
            <div className="eyebrow">Product Signal</div>
            <h2>{signal.title}</h2>
      ...
      <section className="journey-card card">
        <div className="panel-header">
          <div>
            <div className="eyebrow">Demo Journey</div>
