---
name: job-stories
description: "When [situation], I want to [motivation], so I can [outcome] 형식의 job story와 상세 acceptance criteria를 만듭니다. job story를 작성하거나 JTBD 스타일의 백로그 아이템을 만들거나 사용자 상황과 동기를 표현할 때 사용합니다."
---
# Job Stories
