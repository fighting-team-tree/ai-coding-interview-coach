...
description: "비전, 세그먼트, 비용, value proposition, trade-off, 지표, 성장, 역량, defensibility를 담은 9개 섹션 Product Strategy Canvas를 작성합니다. 제품 전략을 수립하거나 전략 계획을 만들거나 제품 방향을 정의할 때 사용합니다."
---
