...
description: LangChain 1.x와 LangGraph를 사용해 agent, memory, tool integration을 포함한 LLM 애플리케이션 아키텍처를 설계합니다. Use when LangChain 기반 앱을 만들거나 AI agent를 구현하거나 복잡한 LLM 워크플로를 설계할 때.
---
