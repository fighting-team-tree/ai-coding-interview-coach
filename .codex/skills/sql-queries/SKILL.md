---
name: sql-queries
description: "자연어 설명으로부터 SQL 쿼리를 생성합니다. BigQuery, PostgreSQL, MySQL 등 여러 방언을 지원하고 업로드된 스키마 다이어그램이나 문서를 읽어 활용합니다. SQL을 작성하거나 데이터 리포트를 만들거나 데이터베이스를 탐색하거나 비즈니스 질문을 쿼리로 바꿀 때 사용합니다."
---
