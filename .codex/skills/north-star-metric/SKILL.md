...
description: "North Star Metric과 이를 보완하는 3~5개의 입력 지표로 metrics constellation을 정의합니다. 비즈니스 게임 유형을 분류하고 효과적인 North Star의 7가지 기준으로 검증합니다. North Star Metric을 정하거나 지표 프레임워크를 설계하거나 무엇을 측정해야 할지 결정할 때 사용합니다."
---
# North Star Metric
