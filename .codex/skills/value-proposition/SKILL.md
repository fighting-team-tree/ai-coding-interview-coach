...
description: "Who, Why, What before, How, What after, Alternatives의 6개 JTBD 구성요소를 활용해 상세한 value proposition을 설계합니다. value proposition을 만들거나 고객 가치 전달 구조를 분석하거나 고객이 왜 제품을 선택해야 하는지 설명할 때 사용합니다."
---
# Value Proposition
