...
description: "RICE, ICE, Kano, MoSCoW, Opportunity Score 등 9가지 우선순위 프레임워크의 공식, 사용 시점, 템플릿을 정리한 레퍼런스 가이드입니다. 어떤 우선순위 방법을 쓸지 고르거나 RICE와 ICE를 비교하거나 프레임워크별 차이를 학습할 때 사용합니다."
---
