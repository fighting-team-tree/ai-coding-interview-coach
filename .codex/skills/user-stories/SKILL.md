---
name: user-stories
description: "3 C(Card, Conversation, Confirmation)와 INVEST 기준을 따르는 user story를 설명, 디자인 링크, acceptance criteria와 함께 작성합니다. user story를 만들거나 기능을 백로그 아이템으로 쪼개거나 acceptance criteria를 정의할 때 사용합니다."
---
# User Stories
