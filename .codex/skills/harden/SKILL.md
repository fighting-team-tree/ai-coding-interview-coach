---
name: harden
description: 인터페이스를 실제 서비스 배포 수준으로 다듬습니다. 에러 처리, 빈 상태, 온보딩 플로우, i18n, 텍스트 오버플로우, 엣지 케이스 관리를 포함합니다. 프로덕션 대응, 엣지 케이스 처리, 에러 상태 추가, 빈 상태 설계, 온보딩 개선, 오버플로우나 i18n 문제 수정을 원할 때 사용합니다.
version: 2.1.1
