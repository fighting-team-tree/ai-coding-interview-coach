...
description: "JTBD 탐색 질문, 워밍업, 핵심 탐색, 마무리 섹션이 포함된 구조화된 고객 인터뷰 스크립트를 만듭니다. The Mom Test 원칙을 따르며 유도 질문과 피칭을 피하고 과거 행동에 집중합니다. 사용자 인터뷰를 준비하거나 인터뷰 가이드를 만들거나 discovery research를 계획할 때 사용합니다."
---
