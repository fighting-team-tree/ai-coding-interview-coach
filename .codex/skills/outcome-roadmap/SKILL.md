...
description: "산출물 중심 로드맵을 전략 의도가 드러나는 outcome 중심 로드맵으로 전환합니다. 이니셔티브를 사용자·비즈니스 영향 중심의 outcome 문장으로 다시 씁니다. outcome roadmap으로 전환하거나 로드맵을 더 전략적으로 만들거나 기능 목록을 outcome으로 재작성할 때 사용합니다."
---
