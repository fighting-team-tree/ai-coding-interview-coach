...
description: "Opportunity Solution Tree(OST)를 구성해 원하는 outcome을 opportunities, solutions, experiments로 연결합니다. Teresa Torres의 Continuous Discovery Habits를 기반으로 합니다. discovery 작업을 구조화하거나 기회를 솔루션에 연결하거나 다음에 무엇을 만들지 판단할 때 사용합니다."
---
