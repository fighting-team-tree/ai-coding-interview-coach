---
name: sprint-plan
description: "capacity estimation, story selection, dependency mapping, risk identification을 포함해 스프린트를 계획합니다. 스프린트 플래닝을 준비하거나 팀 capacity를 추정하거나 스토리를 선택하거나 velocity 대비 범위를 조정할 때 사용합니다."
---
