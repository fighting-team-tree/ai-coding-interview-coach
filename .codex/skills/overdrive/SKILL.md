---
name: overdrive
description: 셰이더, 스프링 물리, 스크롤 기반 리빌, 60fps 애니메이션처럼 기술적으로 대담한 구현으로 인터페이스를 통상적인 한계 너머로 밀어 올립니다. 놀라움을 주고 싶다, 강한 인상을 남기고 싶다, 끝까지 밀어붙이고 싶다, 특별한 무언가를 만들고 싶을 때 사용합니다.
version: 2.1.1
