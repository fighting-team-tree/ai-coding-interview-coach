---
name: test-scenarios
description: "user story로부터 테스트 목적, 시작 조건, 사용자 역할, 단계별 액션, 기대 결과가 포함된 종합 테스트 시나리오를 만듭니다. QA 테스트 케이스를 작성하거나 테스트 플랜을 만들거나 acceptance test를 정의하거나 기능 검증을 준비할 때 사용합니다."
---
# Test Scenarios
