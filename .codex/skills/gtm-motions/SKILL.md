---
name: gtm-motions
description: "Inbound, Outbound, Paid Digital, Community, Partners, ABM, PLG까지 7가지 유형 중 적합한 GTM motion과 도구를 식별합니다. 마케팅 채널을 고르거나 inbound와 outbound 전략 사이에서 선택하거나 크로스채널 캠페인을 계획할 때 사용합니다."
---
# GTM Motions
