---
name: pre-mortem
description: "PRD나 출시 계획을 대상으로 pre-mortem 리스크 분석을 수행합니다. 리스크를 Tigers, Paper Tigers, Elephants로 분류하고, launch-blocking, fast-follow, track으로 재정렬합니다. 출시 준비를 하거나 제품 계획을 스트레스 테스트하거나 실패 가능성을 미리 점검할 때 사용합니다."
---
