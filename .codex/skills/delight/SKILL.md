---
name: delight
description: 인터페이스를 기억에 남고 즐겁게 사용할 수 있도록 기쁨, 개성, 예상 밖의 디테일을 더합니다. 기능적인 상태를 즐거운 경험으로 끌어올립니다. 폴리시, 개성, 애니메이션, 마이크로 인터랙션, 즐거운 포인트를 더하거나 인터페이스를 더 재미있고 기억에 남게 만들고 싶을 때 사용합니다.
version: 2.1.1
