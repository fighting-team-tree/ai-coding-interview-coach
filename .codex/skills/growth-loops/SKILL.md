---
name: growth-loops
description: "지속 가능한 traction을 위한 growth loop를 식별합니다. 바이럴, 사용, 협업, 사용자 생성, 추천의 5가지 루프 유형을 평가합니다. 성장 메커니즘을 설계하거나 product-led traction을 만들거나 growth loop 개념을 이해할 때 사용합니다."
---
# Growth Loops
