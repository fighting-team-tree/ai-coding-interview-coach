---
name: critique
description: UX 관점에서 디자인을 평가하며 시각적 위계, 정보 구조, 감성적 전달력, 인지 부하, 전반적 품질을 정량 점수, 페르소나 기반 테스트, 자동 안티패턴 탐지, 실행 가능한 피드백과 함께 분석합니다. 디자인이나 컴포넌트에 대한 리뷰, 비평, 평가, 피드백을 요청할 때 사용합니다.
version: 2.1.1
