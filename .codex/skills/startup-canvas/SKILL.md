---
name: startup-canvas
description: "신규 제품을 위한 Startup Canvas를 생성합니다. Product Strategy 9개 섹션과 Business Model의 비용·수익 요소를 결합해 BMC와 Lean Canvas의 대안으로 사용합니다. 새 제품을 출시하거나 스타트업 아이디어를 평가할 때 사용합니다."
---
# Startup Canvas
